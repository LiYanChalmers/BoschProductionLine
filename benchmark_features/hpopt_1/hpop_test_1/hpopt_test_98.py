...
param_id = 98
random_state = 831904
param = {'subsample': 0.9, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 16, 'min_child_weight': 5.5, 'max_depth': 2, 'lambda': 4, 'eta': 0.03, 'colsample_bytree': 0.5, 'booster': 'dart', 'base_score': 0.0058, 'alpha': 0.25}
