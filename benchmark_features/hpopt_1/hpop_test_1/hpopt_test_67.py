...
param_id = 67
random_state = 180807
param = {'subsample': 0.85, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 16, 'min_child_weight': 4.5, 'max_depth': 2, 'lambda': 3.5, 'eta': 0.025, 'colsample_bytree': 0.5, 'booster': 'gbtree', 'base_score': 0.0058, 'alpha': 0.25}
