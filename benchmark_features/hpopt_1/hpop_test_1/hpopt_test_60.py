...
param_id = 60
random_state = 285989
param = {'subsample': 0.9, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 16, 'min_child_weight': 5.5, 'max_depth': 2, 'lambda': 4, 'eta': 0.025, 'colsample_bytree': 0.65, 'booster': 'dart', 'base_score': 0.0058, 'alpha': 0}
