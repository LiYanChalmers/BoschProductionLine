...
param_id = 44
random_state = 800347
param = {'subsample': 0.95, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 20, 'min_child_weight': 5, 'max_depth': 2, 'lambda': 4, 'eta': 0.03, 'colsample_bytree': 0.65, 'booster': 'dart', 'base_score': 0.0058, 'alpha': 0}
