...
param_id = 99
random_state = 325776
param = {'subsample': 0.95, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 16, 'min_child_weight': 4.5, 'max_depth': 2, 'lambda': 4, 'eta': 0.025, 'colsample_bytree': 0.55, 'booster': 'dart', 'base_score': 0.0058, 'alpha': 0}
