...
param_id = 69
random_state = 604480
param = {'subsample': 0.85, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 16, 'min_child_weight': 4.5, 'max_depth': 2, 'lambda': 4, 'eta': 0.03, 'colsample_bytree': 0.55, 'booster': 'gbtree', 'base_score': 0.0058, 'alpha': 0}
