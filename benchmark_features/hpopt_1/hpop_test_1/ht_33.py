...
param_id = 33
random_state = 662947
param = {'subsample': 0.85, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 20, 'min_child_weight': 5.5, 'max_depth': 15, 'lambda': 3.5, 'eta': 0.025, 'colsample_bytree': 0.6, 'booster': 'gbtree', 'base_score': 0.0058, 'alpha': 0.1}
