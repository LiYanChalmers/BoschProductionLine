...
param_id = 58
random_state = 677090
param = {'subsample': 0.9, 'silent': 1, 'objective': 'binary:logistic', 'nthread': 20, 'min_child_weight': 4.5, 'max_depth': 14, 'lambda': 3.5, 'eta': 0.025, 'colsample_bytree': 0.55, 'booster': 'gbtree', 'base_score': 0.0058, 'alpha': 0.1}
