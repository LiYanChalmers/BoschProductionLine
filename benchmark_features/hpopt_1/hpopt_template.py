...
param_id = 0
random_state = 4957
param = {"subsample": 0.85, "silent": 1, "objective": "binary:logistic", "nthread": 16, "min_child_weight": 4.5, "max_depth": 4, "lambda": 3.5, "eta": 0.035, "colsample_bytree": 0.6, "booster": "dart", "base_score": 0.0058, "alpha": 0}
np.random.seed(random_state)

#%% Load data
x = pd.read_hdf('numeric_b1_b7_nf149.hdf', 'numeric')
x = x.iloc[:, :30] # only for testing
